...
D3DClass::D3DClass() : m_projectionMatrix(DirectX::XMMatrixIdentity()), m_worldMatrix(DirectX::XMMatrixIdentity()), m_orthoMatrix(DirectX::XMMatrixIdentity())
{
	m_swapChain = 0;
	m_device = 0;
	m_deviceContext = 0;
...
D3DClass::D3DClass(const D3DClass& other) : m_projectionMatrix(DirectX::XMMatrixIdentity()), m_worldMatrix(DirectX::XMMatrixIdentity()), m_orthoMatrix(DirectX::XMMatrixIdentity())
{
}
